...
def parse_args():
    ...
    parser.add_argument("--angRes", type=int, default=6, help="angular resolution")
    parser.add_argument("--upfactor", type=int, default=2, help="upscale factor")
    parser.add_argument('--model_name', type=str, default='DistgSSR_2xSR_6x6')
    parser.add_argument('--testset_dir', type=str, default='../Data/Test_2xSR_4x4/')
...
def test_on_datasets(cfg):
    ...
    torch.save({'epoch': 50, 'state_dict': net.state_dict(), }, './' + cfg.model_name + '.pth.tar')
